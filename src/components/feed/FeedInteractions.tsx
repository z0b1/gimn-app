    ...
    <div className="w-full">
      <div className="flex items-center gap-6 pt-6 border-t border-slate-50 dark:border-slate-800 transition-colors">
        ...
        <button 
           ...
           className={cn(
             "flex items-center gap-2 transition-colors hover:text-brand-primary dark:hover:text-brand-accent",
             showComments ? "text-brand-primary dark:text-brand-accent" : "text-slate-500"
           )}
        >
