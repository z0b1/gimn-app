  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 shadow-xl p-8 w-full max-w-2xl animate-in fade-in zoom-in duration-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
           <label className="block text-sm font-bold text-slate-700 mb-2 px-1">Media URL (Opciono)</label>
           <input
            name="mediaUrl"
            placeholder="https://..."
            className="w-full bg-slate-50 border-none rounded-2xl p-4 text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-indigo-100 transition-all"
            disabled={isPending}
          />
        </div>
